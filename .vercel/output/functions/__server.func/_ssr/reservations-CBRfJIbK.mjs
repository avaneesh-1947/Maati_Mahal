...
import { _ as restaurant, c as Section, g as occasions, l as SectionHeading, m as fullAddress, r as ActionButton, s as PageHero, v as timeSlots } from "./router-CvDEDZRW.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/reservations-CBRfJIbK.js
...
${values.occasion ? `*Occasion:* ${values.occasion.trim()}\n` : ""}${values.request ? `*Special Request:* ${values.request.trim()}\n` : ""}`;
		const whatsappUrl = `https://wa.me/919794293788?text=${encodeURIComponent(messageText)}`;
